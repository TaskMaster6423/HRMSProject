									...
									<div class="profile-view">
										<div class="profile-img-wrap">
											<div class="profile-img">
												<a href="#"><img alt="" src="employees/<?php echo htmlentities($employee->Picture);?>"></a>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														<h3 class="user-name m-t-0 mb-0"><?php echo htmlentities($employee->FirstName . ' ' . $employee->LastName); ?></h3>
														<h6 class="text-muted"><?php echo htmlentities($employee->Department); ?></h6>
														<small class="text-muted"><?php echo htmlentities($employee->Designation); ?></small>
														<div class="staff-id">Employee ID : <?php echo htmlentities($employee->Employee_Id); ?></div>
														<div class="small doj text-muted">Date of Join : <?php echo htmlentities($employee->Joining_Date); ?></div>
												...
												<div class="col-md-7">
													<ul class="personal-info">
														<li>
															...
															<div class="text"><a href=""><?php echo htmlentities($employee->Phone); ?></a></div>
														</li>
														<li>
															<div class="title">Email:</div>
															<div class="text"><a href=""><?php echo htmlentities($employee->Email); ?></a></div>
														</li>
														<li>
