										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="profile.php?id=<?php echo htmlentities($row->id);?>" class="avatar"><img alt="picture" src="employees/<?php echo htmlentities($row->Picture);?>"></a>
													<a href="profile.php?id=<?php echo htmlentities($row->id);?>"><?php echo htmlentities($row->FirstName)." ".htmlentities($row->LastName); ?><span><?php echo htmlentities($row->Designation);?></span></a>
												</h2>
											</td>
